                ...
                <?php else: ?>
                    <?php foreach ($bilhetes as $b): ?>
                        <div class="linha-bilhete">
                            ...
                            <input type="text" name="bilhete_nome[]" value="<?= htmlspecialchars($b['nome']) ?>" placeholder="Nome" class="input-bilhete">
                            <input type="number" step="0.01" name="bilhete_preco[]" value="<?= $b['preco'] ?>" placeholder="Preço (€)" class="input-bilhete">
                            <input type="number" name="bilhete_qtd[]" value="<?= $b['qtd_total'] ?>" placeholder="Qtd Total" class="input-bilhete">
